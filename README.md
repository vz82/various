...
The .sh file contained above is a fix for an article written back in 2019 [(https://vedran-zulin.com/cybersec-it-sec-it-it-grc/cybersecurity/ibm-qradar-a-script-for-updating-your-wincollect-on-the-console.html)), as the link to the .sh file on my site doesn't seem to be working anymore.
